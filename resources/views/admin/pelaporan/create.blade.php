                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('Pelaporan.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="kejadian" name="kejadian"
                                    value="{{ old('kejadian') }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select class="form-select" id="jenis_kejadian" name="jenis_kejadian" required>
                                    <option value="kebakaran" {{ old('jenis_kejadian') == 'kebakaran' ? 'selected' : '' }}>
                                        Kebakaran</option>
                                    <option value="penyelamatan"
                                        {{ old('jenis_kejadian') == 'penyelamatan' ? 'selected' : '' }}>Penyelamatan
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="date" class="form-control" id="hari_kejadian" name="hari_kejadian"
                                    value="{{ old('hari_kejadian') }}" required>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-sm-10 row">
                                <div class="col-md-3">
                                    ...
                                    <input type="time" class="form-control" id="laporan_masuk" name="laporan_masuk"
                                        value="{{ old('laporan_masuk') }}" required>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="time" class="form-control" id="berangkat" name="berangkat"
                                        value="{{ old('berangkat') }}" required>
                                    <small class="form-text text-muted">Format: HH:MM AM/PM</small>
                                </div>
                                <div class="col-md-3">
                                    <label for="tiba" class="form-label">Tiba</label>
                                    <input type="time" class="form-control" id="tiba" name="tiba"
                                        value="{{ old('tiba') }}" required>
                                    <small class="form-text text-muted">Format: HH:MM AM/PM</small>
                                </div>
                                <div class="col-md-3">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="data_diri" name="data_diri"
                                    value="{{ old('data_diri') }}">
                            </div>
                        </div>
                                ...
                                @foreach ($personnels as $personnel)
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input"
                                            id="personil{{ $personnel->id }}" name="personil[]"
                                            value="{{ $personnel->personil }}"
                                            {{ is_array(old('personil')) && in_array($personnel->personil, old('personil')) ? 'checked' : '' }}>
                                        <label class="form-check-label"
                                            for="personil{{ $personnel->id }}">{{ $personnel->personil }}</label>
                                    </div>
                                @endforeach
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="file" class="form-control" id="dokumentasi" name="dokumentasi"
                                    accept="image/*" onchange="previewImage('dokumentasi', 'previewDokumentasi')">
                                <img id="previewDokumentasi" src="{{ old('previewDokumentasi') }}"
                                    alt="Preview Dokumentasi" style="max-height: 150px; margin-top: 10px;">
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-3">
                            <div class="text-center">
                                ...
                                <a href="{{ route('Pelaporan.button_perkejadian') }}"
