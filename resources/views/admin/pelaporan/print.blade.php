...
<body>
    ...
    {{-- <div class="header" style="display: flex; align-items: center;">
        ...
        <div>
            <h1>Dinas Pemadam Kebakaran Banyuwangi</h1>
            <p>Jl. Raya Pemadam Kebakaran No. 1, Banyuwangi</p>
        </div>
    </div> --}}
    {{-- <div class="header" style="display: grid; grid-template-columns: auto 1fr; align-items: center;">
        <img src="{{ public_path('images/logo_damkar_persegi.png') }}" alt="Logo Dinas Pemadam Kebakaran" style="width: 100px; height: auto; margin-right: 10px;"/>
                ...
                <tr>
                    ...
                    {{-- <td>
                        @if ($laporan->data_diri)
                            <img src="{{ asset('storage/' . $laporan->data_diri) }}" alt="Data Diri" class="img-fluid"
                    ...
                    <td>
                        @if ($laporan->dokumentasi)
                            <img src="{{ asset('storage/' . $laporan->dokumentasi) }}" alt="Dokumentasi" class="img-fluid"
                                style="max-height: 200px; width: auto;">
                        @else
